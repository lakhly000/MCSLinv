...
3. inputExample.txt and expExample.csv: These are two example inputs. With these inputs, the program should run for 3-10 minutes and should output the example output file corresponding to the user's choice of SPRNG version.
...
3. MCSLoutputEx2.csv: Example output file for SPRNG 2.0b. The program should output this if SPRNG 2.0b is used, given the input files inputExample.txt and expExample.txt.

3. MCSLoutputEx5.csv: Example output file for SPRNG 5.0. The program should output this if SPRNG 5.0 is used, given the input files inputExample.txt and expExample.txt.
...
6. Compiler not recognizing vector: User must use a compiler that is compatible with C++ 0x or higher.
